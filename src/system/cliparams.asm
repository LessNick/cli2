...
op_strA		equ	op_cycleA + 26 * 6			; адрес начала данных переменных типа string
								...
								; Переменные A-Z. По умолчанию равны -0 (undef), диапазон от -32768 до 32767
; op_varA		dw	#8000					; %A -0 = undef
; op_varB		dw	#8000					; %B
; op_varC		dw	#8000					; %C
; op_varD		dw	#8000					; %D
; op_varE		dw	#8000					; %E
...
;---------------------------------------------
								; Цыклы A-Z. Начальное значение, конечное значение
								; По умолчанию равны -0 (undef), диапазон от -32768 до 32767
; op_cycleA	dw	#8000,#8000				; %A -0 = undef
; op_cycleB	dw	#8000,#8000				; %B
; op_cycleC	dw	#8000,#8000				; %C
; op_cycleD	dw	#8000,#8000				; %D
; op_cycleE	dw	#8000,#8000				; %E
; op_cycleF	dw	#8000,#8000				; %F
; op_cycleG	dw	#8000,#8000				; %G
; op_cycleH	dw	#8000,#8000				; %H
; op_cycleI	dw	#8000,#8000				; %I
; op_cycleJ	dw	#8000,#8000				; %J
; op_cycleK	dw	#8000,#8000				; %K
; op_cycleL	dw	#8000,#8000				; %L
; op_cycleM	dw	#8000,#8000				; %M
; op_cycleN	dw	#8000,#8000				; %N
; op_cycleO	dw	#8000,#8000				; %O
; op_cycleP	dw	#8000,#8000				; %P
; op_cycleQ	dw	#8000,#8000				; %Q
; op_cycleR	dw	#8000,#8000				; %R
; op_cycleS	dw	#8000,#8000				; %S
; op_cycleT	dw	#8000,#8000				; %T
; op_cycleU	dw	#8000,#8000				; %U
; op_cycleV	dw	#8000,#8000				; %V
; op_cycleW	dw	#8000,#8000				; %W
; op_cycleX	dw	#8000,#8000				; %X
; op_cycleY	dw	#8000,#8000				; %Y
; op_cycleZ	dw	#8000,#8000				; %Z
