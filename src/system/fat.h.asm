...
;---------------------------------------
fDeviceInit			equ	#03		; +3: Инициализация устройства (вызывается 1 раз при запуске boot.$c)
							; o: NZ - устройство не найдено (не вставлена SD карта?)

fFatInit			equ	#09		; +9: Инициализация устройства (вызывается 1 раз при запуске boot.$c)
							; o: NZ - устройство не инициализировано (не найдена FAT32 разметка)
...
fDriverUnpack			equ	#1B		; +27: Распаковка драйвера (вызывается 1 раз при запуске boot.$c)
