...
fileNotFoundMsg	db	"File ",pQuoteOpen,#00
fileNotFoundMsg0 db	pQuoteClose," not found.",#0d,#00
...
bootErrorMgs	db	"System file ",pQuoteOpen,#00
bootErrorMgs0	db	pQuoteClose," not found.",#0d,#00
...
helpMsg2	db	"Available operators",#00

helpMsg3	db	"(external):",#0d,#00
