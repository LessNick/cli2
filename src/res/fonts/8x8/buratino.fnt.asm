...
nFont		db	"Buratino",#00				; * байт название шрифта, оканчивающихся кодом #00
neFont		
		dw	aeFont-aFont				; 2 байта длина автора шрифта
aFont		db	"Copper Feet",#00			; * байт автор шрифта, оканчивающихся кодом #00
aeFont		
		dw	deFont-dFont				; 2 байта длина описания шрифта
dFont		db	"Font from game \"Buratino\"",#00	; * байт описание шрифта, оканчивающихся кодом #00
deFont

bFont		incbin  "rc/fonts/8x8/buratino.bin"			; Начало данных шрифта
eFont
...
; 	DISPLAY "bFont-taFont",/A,bFont-taFont
	...
	SAVEBIN "install/system/res/fonts/8x8/buratino.fnt", sFont, eFont-sFont
