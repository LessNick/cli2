...
sPal2
		...
		dw	ePal2-bPal2				; 2 байта размер палитры
		dw	bPal2-taPal2				; 2 байта смещение от текущего адреса до начала данных палитры

taPal2								; Зарезервировано для дальнейшего разширения
		
bPal2		dw	#0000,#0010,#4000,#4010
		dw	#0200,#0210,#4200,#4210
		dw	#0000,#0018,#6000,#6018
		dw	#0300,#0318,#6300,#6318
ePal2

	SAVEBIN "install/system/res/pals/zx.pal", sPal2, ePal2-sPal2
